...
public class UMAttributeValueReferenceImpl extends ASTWrapperPsiElement implements UMAttributeValueReference {

  public UMAttributeValueReferenceImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull UMVisitor visitor) {
    visitor.visitAttributeValueReference(this);
  }
