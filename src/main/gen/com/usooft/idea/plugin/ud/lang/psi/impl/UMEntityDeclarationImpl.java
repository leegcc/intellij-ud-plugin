...
public class UMEntityDeclarationImpl extends UMNamedElementImpl implements UMEntityDeclaration {

  public UMEntityDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<UMEntityBody> getEntityBodyList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, UMEntityBody.class);
  }
