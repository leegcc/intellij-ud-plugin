...
public class UMRelationTargetImpl extends ASTWrapperPsiElement implements UMRelationTarget {

  public UMRelationTargetImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull UMVisitor visitor) {
    visitor.visitRelationTarget(this);
  }
