...
public class UMRelationNameImpl extends ASTWrapperPsiElement implements UMRelationName {

  public UMRelationNameImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull UMVisitor visitor) {
    visitor.visitRelationName(this);
  }
