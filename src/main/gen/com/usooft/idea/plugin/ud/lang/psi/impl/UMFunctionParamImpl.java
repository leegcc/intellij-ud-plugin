...
public class UMFunctionParamImpl extends ASTWrapperPsiElement implements UMFunctionParam {

  public UMFunctionParamImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public UMAttributeValue getAttributeValue() {
    return findNotNullChildByClass(UMAttributeValue.class);
  }
