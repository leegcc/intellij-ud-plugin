...
public class UMFunctionParamsImpl extends ASTWrapperPsiElement implements UMFunctionParams {

  public UMFunctionParamsImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<UMFunctionParam> getFunctionParamList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, UMFunctionParam.class);
  }
