...
public class UMMethodsBlockImpl extends ASTWrapperPsiElement implements UMMethodsBlock {

  public UMMethodsBlockImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<UMMethodDeclaration> getMethodDeclarationList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, UMMethodDeclaration.class);
  }
