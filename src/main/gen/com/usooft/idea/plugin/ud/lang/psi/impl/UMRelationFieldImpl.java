...
public class UMRelationFieldImpl extends ASTWrapperPsiElement implements UMRelationField {

  public UMRelationFieldImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull UMVisitor visitor) {
    visitor.visitRelationField(this);
  }
