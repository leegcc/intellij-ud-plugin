...
public class UMMethodParamsImpl extends ASTWrapperPsiElement implements UMMethodParams {

  public UMMethodParamsImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<UMMethodParam> getMethodParamList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, UMMethodParam.class);
  }
