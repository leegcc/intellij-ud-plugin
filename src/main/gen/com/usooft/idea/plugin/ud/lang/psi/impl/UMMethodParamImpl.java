...
public class UMMethodParamImpl extends ASTWrapperPsiElement implements UMMethodParam {

  public UMMethodParamImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public UMMethodParamValue getMethodParamValue() {
    return findChildByClass(UMMethodParamValue.class);
  }
